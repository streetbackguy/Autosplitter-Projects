    ...
    settings.Add("MWOFWT", true, "Mandragora: Whispers of the Witch Tree");
        settings.Add("MQUESTS", true, "Splits for Main Quest Completion","MWOFWT");
            settings.Add("WitchHunt_3", true, "Witch Hunt","MQUESTS");
                settings.Add("Maddick_3", false, "Objective 1","WitchHunt_3");
                settings.Add("SwampObj1_3", false, "Objective 2","WitchHunt_3");
                settings.Add("AfterClayborn_3", false, "Objective 3","WitchHunt_3");
                settings.Add("Capture1_3", false, "Objective 4","WitchHunt_3");
                settings.Add("Capture2_3", false, "Objective 5","WitchHunt_3");
                settings.Add("Capture3_3", false, "Objective 6","WitchHunt_3");
                settings.Add("SwampObj2_3", false, "Objective 7","WitchHunt_3");
                settings.Add("Seal1_3", false, "Objective 8","WitchHunt_3");
                settings.Add("Seal2_3", false, "Objective 9","WitchHunt_3");
                settings.Add("SwampObj3_3", false, "Objective 10","WitchHunt_3");
            settings.Add("WolfAttack_3", true, "Wolf Attack","MQUESTS");
                settings.Add("Wargquest_Obj1_3", false, "Objective 1","WolfAttack_3");
                settings.Add("Wargquest_Obj2_3", false, "Objective 2","WolfAttack_3");
            settings.Add("Clayborne'sRequest_3", true, "Clayborne's Request","MQUESTS");
                settings.Add("Sewers_Ob1_3", false, "Objective 1","Clayborne'sRequest_3");
                settings.Add("Sewers_Ob2_3", false, "Objective 2","Clayborne'sRequest_3");
            settings.Add("ANoble'sDeath_3", true, "A Noble's Death","MQUESTS");
                settings.Add("Braer1_3", false, "Objective 1","ANoble'sDeath_3");
                settings.Add("Braer4_3", false, "Objective 2","ANoble'sDeath_3");
                settings.Add("Braer5_3", false, "Objective 3","ANoble'sDeath_3");
                settings.Add("Feri1_3", false, "Objective 4","ANoble'sDeath_3");
                settings.Add("Feri2_3", false, "Objective 5","ANoble'sDeath_3");
                settings.Add("Feri3_3", false, "Objective 6","ANoble'sDeath_3");
                settings.Add("Feri4_3", false, "Objective 7","ANoble'sDeath_3");
                settings.Add("Braer2_3", false, "Objective 8","ANoble'sDeath_3");
                settings.Add("Braer3_3", false, "Objective 9","ANoble'sDeath_3");
            settings.Add("FindaFriend_3", true, "Find a Friend","MQUESTS");
                settings.Add("Friend1_3", false, "Objective 1","FindaFriend_3");
                settings.Add("Friend2_3", false, "Objective 2","FindaFriend_3");
            settings.Add("TheTomeMistress_3", true, "Tome Mistress","MQUESTS");
                settings.Add("Tome1_3", false, "Objective 1","TheTomeMistress_3");
                settings.Add("Tome2_3", false, "Objective 2","TheTomeMistress_3");
                settings.Add("Tome3_3", false, "Objective 3","TheTomeMistress_3");
            settings.Add("DragonHeart_3", true, "Dragon Heart","MQUESTS");
                settings.Add("Dragon1_3", false, "Objective 1","DragonHeart_3");
                settings.Add("Dragon2_3", false, "Objective 2","DragonHeart_3");
                settings.Add("Dragon3_3", false, "Objective 3","DragonHeart_3");
                settings.Add("Dragon4_3", false, "Objective 4","DragonHeart_3");
                settings.Add("Dragon5_3", false, "Objective 5","DragonHeart_3");
            settings.Add("NoDirections_3", true, "An Unusual Alliance","MQUESTS");
                settings.Add("Direction1_3", false, "Objective 1","NoDirections_3");
                settings.Add("Direction2_3", false, "Objective 2","NoDirections_3");
                settings.Add("Direction3_3", false, "Objective 3","NoDirections_3");
            settings.Add("TheWitchCoven_3", true, "The Witch Coven","MQUESTS");
                settings.Add("Coven1_3", false, "Objective 1","TheWitchCoven_3");
                settings.Add("Coven2_3", false, "Objective 2","TheWitchCoven_3");
                settings.Add("Coven3_3", false, "Objective 3","TheWitchCoven_3");
                settings.Add("Coven4_3", false, "Objective 4","TheWitchCoven_3");
                settings.Add("Coven5_3", false, "Objective 5","TheWitchCoven_3");
            settings.Add("TheCrimsonCity_3", true, "The Crimson City","MQUESTS");
                settings.Add("Crimson_01_3", false, "Objective 1","TheCrimsonCity_3");
                settings.Add("Crimson_02_3", false, "Objective 2","TheCrimsonCity_3");
                settings.Add("Crimson1_3", false, "Objective 3","TheCrimsonCity_3");
                settings.Add("Crimson2_3", false, "Objective 4","TheCrimsonCity_3");
                settings.Add("Crimson3_3", false, "Objective 5","TheCrimsonCity_3");
        settings.Add("BOSSES", false, "Splits for Defeating each Boss","MWOFWT");
