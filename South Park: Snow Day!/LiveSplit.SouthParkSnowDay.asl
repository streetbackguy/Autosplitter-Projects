...
state("SnowDay-Win64-Shipping", "Steam 1.50")
{
    byte Loads: 0x05693E68, 0x300, 0x108, 0xC8, 0x58;
    byte ClosingScreen: 0x56A1A80, 0x120, 0x2C8, 0x4B0, 0xA0, 0x340;
    string10 StorySummary: 0x56A1A80, 0x120, 0x2C8, 0x4B0, 0xA0, 0x3C0, 0x0;
    uint ChapterVictory: 0x522EF24;
}
    ...
    switch (MD5Hash)
            {
                ...
                case "2E185CCF4EE0C8B18BFB9E5A7546FFF3":
                    version = "Steam 1.50";
                    break;
