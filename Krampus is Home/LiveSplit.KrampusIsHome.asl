...
init
{
    ...
    vars.Helper.TryLoad = (Func<dynamic, bool>)(mono =>
    {
        ...
        vars.Helper["CutscenePlaying"] = smd.Make<bool>("StoryMode_Director_S", "Cutscene_Playing");
        vars.Helper["ObjOn"] = smd.MakeString("StoryMode_Director_S", "Objective_Director_G");
...
update
{
    ...
    if(current.ObjOn != old.ObjOn)
    {
        vars.Log("Ojective On?: " + old.ObjOn + " -> " + current.ObjOn);
    }
...
split
{
    ...
    if(current.StoryPart == 49 && !current.CutscenePlaying)
    {
